...
app.use("/"+assets+"js/core/", express.static(__dirname + "/"+assets+"js/core/",{maxAge:31536000000}));
app.use("/"+assets+"js/plugins/", express.static(__dirname + "/"+assets+"js/plugins/",{maxAge:31536000000}));
